...
class LfD():
    ...
    def execute_start(self, speed_factor: float):
        ...
        self.robot.go_to_pose_ik(transform_pose(self.data['recorded_pose'][0],self.total_transform), interp_dist=speed_factor*0.001, interp_dist_joint=speed_factor*0.005) 
        self.set_stiffness_execution()
